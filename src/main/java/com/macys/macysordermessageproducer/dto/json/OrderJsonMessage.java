package com.macys.macysordermessageproducer.dto.json;

import com.fasterxml.jackson.annotation.JsonProperty;

import java.io.Serializable;

public class OrderJsonMessage implements Serializable {
    ...
    public OrderJsonMessage() {
    }

    public OrderJsonMessage(String messageName, String imagePathname, double itemHeight, String upcList, double itemLength, String command, String itemName, String pickType, double itemWidth, String rfidTagged, String itemDescription, int storageAttribute, double itemWeight) {
